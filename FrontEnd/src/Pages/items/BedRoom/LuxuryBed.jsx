          ...
          >
            ...
            <div className="p-4 space-y-2">
              ...
              <motion.button
                ...
                className="w-full bg-[#E7A933] text-white text-lg py-2 rounded-lg shadow-md flex justify-center items-center gap-2 transition-all duration-300 hover:bg-[#E7A933] hover:scale-105"
                whileTap={{ scale: 0.95 }}
              >
